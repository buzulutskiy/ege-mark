...
(function () {
  ...
  Object.assign(DRAW, {
    ...
    avgTimeWeights() {
      ...
      s += text(X(3) + 30, yAx + 16, "ч", { size: 13, anchor: "start", italic: true });
    ...
    avgFlatten() {
      return withCaption(GRAPH.plot({
        ...
        y: { label: "v, м/с", from: 0, to: 18, step: 3, tick: 3 },
        ...
        /* пунктир вниз от высоты средней: показывает правый край прямоугольника */
        guides: [[[9.7, 11.6], [9.7, 2.6]]],
        notes: [
          { x: 5, y: 12.9, t: "средняя 12 м/с", color: "#1d4ed8", size: 13 },
          { x: 9.7, y: 1.6, t: "тот же путь 120 м", color: "#1d4ed8", size: 13, anchor: "end" },
        ],
